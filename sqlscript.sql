...
BEGIN
	...
	dbms_output.put_line( 'le nb demployee est :' || v_nb_employees_1 );
	v_propotion := (v_nb_employees_1/v_nb_employees)*100;
...
DECLARE
    v_employee_id int;
    TYPE record_employee
    IS RECORD(
         v_last_name EMPLOYEES.LAST_NAME%TYPE,
         v_first_name EMPLOYEES.FIRST_NAME%TYPE,
         v_hire_date EMPLOYEES.HIRE_DATE%TYPE
    );
     employee record_employee_employee;
...
BEGIN 
    ...
    dbms_output.put_line('product_name : ' || product_record.product_name); 
    dbms_output.put_line('description : ' || product_record.description ); 
    dbms_output.put_line('standard_cost: ' || product_record.standard_cost); 
    dbms_output.put_line('list_price: ' || product_record.list_price); 
    dbms_output.put_line('category_id: ' || product_record.category_id); 
END;
